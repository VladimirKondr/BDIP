...
\begin{titlepage}
  ...
  \begin{flushright}
    \textbf{Выполнили:} студенты 3 группы кафедры БМИ\\[4pt]
    Кондратёнок Владимир\\[4pt]
    Волковец Дмитрий\\[4pt]
    Наумович Михаил\\[10pt]
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../output/exp1_SVMLinearWrapper.png}
    \caption{SVM (линейное)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../output/exp1_RFWrapper.png}
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../output/exp2_SVMLinearWrapper.png}
    \caption{SVM (линейное)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../output/exp2_RFWrapper.png}
    \caption{Random Forest}
  \end{subfigure}
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../output/exp3_SVMLinearWrapper.png}
    \caption{SVM (линейное)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../output/exp3_RFWrapper.png}
    \caption{Random Forest}
  \end{subfigure}
